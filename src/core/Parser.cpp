...
const static std::array<std::vector<PrimitiveType>, PrimitiveType::Count> SafeAutomaticCasts = {{
    ...
    {PrimitiveType::Char},
    // U16,
    {PrimitiveType::Char, PrimitiveType::U8},
    // U32,
    {PrimitiveType::Char, PrimitiveType::U16, PrimitiveType::U8},
    // U64,
    {PrimitiveType::Char, PrimitiveType::U32, PrimitiveType::U16, PrimitiveType::U8},
    // I8,
    {},
    // I16,
